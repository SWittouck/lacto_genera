...
genome_pairs_extended %>% classification_assessment(cni, 0.70)

# number of genomes that can be classified through ANI
genome_pairs_extended %>% classification_assessment(ani, 0.75)
